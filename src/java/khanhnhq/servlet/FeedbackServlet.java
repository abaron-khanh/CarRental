...
public class FeedbackServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            dao.setFeedback(id, content, Integer.parseInt(star));
        }
        catch (Exception e) 
        {
            log("Error at FeedbackServlet" + e.getMessage());
        }
        finally
        {
            request.getRequestDispatcher("LoadHistoryServlet").forward(request, response);
        }
    }
